<?php
	...
	class Photos extends Controller{
		...
		public function __construct(){
			...
			$this->order = 'p_id';
			$this->photos_params = $this->params->loadParamsFromControllerFile('params','photos');
			$this->sorting_panel = $this->photos_params['sorting_panel'];
		...
		public function prepareSortingPanel(){
			foreach($this->sorting_panel as $key=>$value){
				...
				$new_array = array('users','photos',$this->user_id);
		...
		public function appendResponse(){
			...
			$this->response->breadcrumb('index')
				->setIcon(null)
				->setLink('users','photos',$this->user_data['u_id'])
