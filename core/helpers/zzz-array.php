<?php
	...
	if(!function_exists('fx_reverse_array')){
	...
	if(!function_exists('fx_reverse_array_callback')){
	...
	if(!function_exists('fx_array_callback')){
	...
	if(!function_exists('fx_array_callback_recursive')){
		/*
	...
	if(!function_exists('fx_implode_recursive')){
	...
	if(!function_exists('fx_set_multilevel_array')){
		/*
			$input_data = array(
				'some_one'=>'some_body',
				'some_shit'=>'some_fuck'
			...
			fx_die($_SESSION);
		 */
		function fx_set_multilevel_array(&$input_array = array(),$data_to_set,...$keys){
			$output_array = array();
			$search_keys_string = '';
			if($keys){
				foreach($keys as $key){
			...
			eval('return $input_array'.$search_keys_string.' = $output_array'.$search_keys_string.' = $data_to_set;');
			return $output_array;
		}
	}

	if(!function_exists('fx_get_multilevel_array')){
		/*
			$input_data = array(
				'some_one'=>'some_body',
				'some_shit'=>'some_fuck'
	...
	if(!function_exists('fx_htmlentities')){
	...
	if(!function_exists('fx_htmlspecialchars')){
