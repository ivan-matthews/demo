<?php
	...
	if(!function_exists('fx_prepare_memory')){
	...
	if(!function_exists('fx_get_files_callback')){
	...
	if(!function_exists('fx_load_array')){
	...
	if(!function_exists('fx_make_dir')){
	...
	if(!function_exists('fx_scandir_callback')){
	...
	if(!function_exists('fx_resize_image')){
		/**
	...
	if(!function_exists('fx_crop_image')){
		/**
	...
	if(!function_exists('fx_crop_and_resize_image')){
		/**
