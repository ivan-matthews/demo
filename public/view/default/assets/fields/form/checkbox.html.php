<?php
	...
	$attributes['class'] .= ' custom-control-checkbox';
...
<div class="form-check form-block <?php print $attributes['params']['original_name'] ?> <?php print $attributes['params']['field_sets_field_class'] ?>">
