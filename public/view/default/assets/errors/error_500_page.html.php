...
<div class="container">
	<div class="compcontainer">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90.5 74.769">
			...
			<path fill="#373F45" d="M90.5 52.063c0 1.917-2.025 3.471-4.525 3.471H4.525C2.025 55.534 0 53.98 0 52.063V3.471C0 1.554 2.026 0 4.525 0h81.449c2.5 0 4.525 1.554 4.525 3.471v48.592z"></path>
			<path fill="#F1F2F2" d="M84.586 46.889c0 1.509-1.762 2.731-3.936 2.731H9.846c-2.172 0-3.933-1.223-3.933-2.731V8.646c0-1.508 1.761-2.732 3.933-2.732H80.65c2.174 0 3.936 1.225 3.936 2.732v38.243z"></path>
			<path fill="#A2A7A5" d="M16.426 5.913L8.051 23h13l-6.875 12.384L26.75 46.259l-8.375-11.375L26.75 20H14.625l6.801-14.087zM68.551 49.62l-8.375-17.087h13l-6.875-12.384L78.875 9.274 70.5 20.649l8.375 14.884H66.75l6.801 14.087z"></path>
		</svg>
	</div>
	<h1 class="header">Ошибка 500!</h1>
	<div class="error500">Внутренняя ошибка сервера!</div>
	<div class="instructions">
		<h2>Что-то где-то сломалось... Администрации сайта уже сообщили о поломке. Совсем скоро ошибка будет устранена.</h2>
		<p>Попробуйте пока что выполнить следующие действия:</p>
		<div class="step">
		...
		<div class="step">
			...
			<p>Подождать несколько секунд и повторить действия снова</p>
		</div>
