<script>
	document.addEventListener("DOMContentLoaded", function(event){
		tinymce.init({
			...
			" searchreplace table template visualblocks hr pagebreak" +
			" code print autoresize" +
			" wordcount searchreplace" +
			"",
			toolbar: /*false*/
			"bold italic underline strikethrough|" +
			"superscript subscript emoticons |" +
			"alignleft aligncenter alignright alignjustify|" +
			"forecolor backcolor table|" +
			"blockquote codesample charmap|" +
			"bullist numlist|" +
			"link image media video|" +
			"fontsizeselect formatselect fontselect|" +
			"preview fullscreen wordcount code print searchreplace|", // help
